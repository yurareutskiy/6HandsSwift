...
-(void)setTintColor:(UIColor *)tintColor{
    ...
    struct CGColor *color2 = [UIColor blackColor].CGColor;


    [CATransaction begin];
    [CATransaction setAnimationDuration:0.5];
    [CATransaction setAnimationTimingFunction:[CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut] ];
    self.sliderLine.backgroundColor = color2;
    
    self.leftHandle.backgroundColor = color;
    self.leftHandle.borderColor = color2;
    self.leftHandle.borderWidth = 1.f;
    
    self.rightHandle.backgroundColor = color;
    self.rightHandle.borderColor = color2;
